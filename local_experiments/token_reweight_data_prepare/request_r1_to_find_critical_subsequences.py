...
if __name__ == "__main__":
    ...
    with open(os.path.join(data_dir, "page_info_single_turn_hangqing_final_with_key_0127.json"), 'r',
              encoding="UTF-8") as rf:
        list_train_samples = json.load(rf)

    output_file = os.path.join(data_dir, "page_info_single_turn_hangqing_final_with_key_0127_r1_critical_tokens.jsonl")
    set_keys = set()
    list_runned_samples = []
    list_samples_new = []
    key_name = 'channelId'
